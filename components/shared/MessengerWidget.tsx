  ...
  return (
    ...
    >
        ...
        {open && (
          ...
          >
            {messengers.map((m, i) => (
              <motion.div
                key={m.id}
                initial={reducedMotion ? {} : { opacity: 0, scale: 0.6, y: 12 }}
              ...
              >
                ...
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    ;(e.currentTarget as HTMLElement).style.boxShadow = `0 6px 24px ${m.color}88`
                  }}
                  onMouseLeave={(e) => {
                    ;(e.currentTarget as HTMLElement).style.transform = 'scale(1)'
                    ;(e.currentTarget as HTMLElement).style.boxShadow = `0 4px 16px ${m.color}55`
                  }}
                >
                  {m.icon}
                </a>
      ...
      <motion.button
        onClick={() => setOpen((v) => !v)}
        animate={
          bounced && !open && !reducedMotion
            ? { y: [0, -10, 0, -5, 0], transition: { duration: 0.6, ease: 'easeInOut' } }
            : {}
        }
        ...
        style={{
          ...
          justifyContent: 'center',
          color: '#fff',
          boxShadow: '0 6px 24px rgba(26,110,255,0.45)',
          border: 'none',
          cursor: 'pointer',
          position: 'relative',
          zIndex: 1,
